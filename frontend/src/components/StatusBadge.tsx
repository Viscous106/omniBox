...
const config: Record<string, { color: string; dot: string; label: string }> = {
  ...
  PLANNING_COMPLETED: { color: "text-purple-400 bg-purple-400/10 border-purple-400/20", dot: "bg-purple-400 animate-pulse", label: "Review Plan" },
  ...
  WAITING_APPROVAL: { color: "text-orange-400 bg-orange-400/10 border-orange-400/20", dot: "bg-orange-400 animate-pulse", label: "Needs Approval" },
  WAITING_CREDENTIAL: { color: "text-amber-400 bg-amber-400/10 border-amber-400/20", dot: "bg-amber-400 animate-pulse", label: "Credential" },
};
